  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      if (email === 'user@example.com' && password === 'password') {
        // Successful login would redirect or update auth context
        console.log('Login successful');
        // In a real app, we'd redirect here or update auth state
      } else {
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-neutral-600 mt-2">
              Sign in to your TechTrove account
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="appearance-none block w-full px-4 py-3 border border-neutral-300 rounded-md shadow-sm placeholder-neutral-400 focus:outline-none focus:ring-primary focus:border-primary"
