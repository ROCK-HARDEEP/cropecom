        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-neutral-300 mb-4">
              Your one-stop shop for all premium electronics and gadgets.
              We provide the latest tech innovations with exceptional service.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/shop" className="text-neutral-300 hover:text-white transition-colors">Shop</Link>
              </li>
              <li>
                <Link to="/about" className="text-neutral-300 hover:text-white transition-colors">About Us</Link>
              </li>
              <li>
                <Link to="/cart" className="text-neutral-300 hover:text-white transition-colors">Cart</Link>
              </li>
              <li>
                <Link to="/login" className="text-neutral-300 hover:text-white transition-colors">My Account</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/shop?category=laptops" className="text-neutral-300 hover:text-white transition-colors">Laptops</Link>
              </li>
              <li>
                <Link to="/shop?category=smartphones" className="text-neutral-300 hover:text-white transition-colors">Smartphones</Link>
              </li>
              <li>
                <Link to="/shop?category=tablets" className="text-neutral-300 hover:text-white transition-colors">Tablets</Link>
              </li>
              <li>
                <Link to="/shop?category=accessories" className="text-neutral-300 hover:text-white transition-colors">Accessories</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form className="flex">
              <input
                ...
                className="px-4 py-2 bg-neutral-700 text-white rounded-l-md focus:outline-none w-full"
              />
              <button
                type="submit"
